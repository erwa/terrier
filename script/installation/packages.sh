...
install_linux() {
  ...
  apt-get -y install \
   ...
   wget http://repo.atlantic.net/ubuntu/pool/universe/libp/libpqxx/libpqxx-dev_6.2.4-4_amd64.deb
   wget http://repo.atlantic.net/ubuntu/pool/universe/libp/libpqxx/libpqxx-6.2_6.2.4-4_amd64.deb
